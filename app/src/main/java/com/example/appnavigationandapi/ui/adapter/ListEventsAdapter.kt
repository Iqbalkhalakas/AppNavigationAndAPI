package com.example.appnavigationandapi.ui.adapter
...
import com.example.appnavigationandapi.data.response.ListEventsItem
import com.example.appnavigationandapi.ui.detailevent.DetailEventActivity
    ...
    class MyViewHolder(private val binding: ItemListEventsBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(event: ListEventsItem) {
            ...
            itemView.setOnClickListener {
                ...
                Log.e("kirimdata","error ${event.id}")
